...
export const drawerProps = () => ({
  ...
  push: PropTypes.oneOfType([
    PropTypes.looseBool,
    { type: Object as PropType<PushState> }
  ]),
...
export type DrawerProps = Partial<
  ExtractPropTypes<ReturnType<typeof drawerProps>>
>
...
const Drawer = defineComponent({
  ...
  setup(props, { emit, slots, attrs }) {
    ...
    const offsetStyle = computed(() => {
      ...
      if (placement === 'left' || placement === 'right') {
        const defaultWidth = size === 'large' ? 736 : 400
        ...
        val.height =
          typeof val.height === 'string' ? val.height : `${val.height}px`
      }
      return val
    })
    ...
    const renderBody = (prefixCls: string) => {
      ...
      return (
        ...
        >
          ...
          <div class={`${prefixCls}-body`} key="body" style={bodyStyle}>
            {slots.default?.()}
          </div>
